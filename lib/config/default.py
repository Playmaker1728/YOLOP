...
_C.PIN_MEMORY = False
_C.PRINT_FREQ = 20
_C.AUTO_RESUME =True           #自动恢复训练Resume from the last training interrupt
...
# _C.DATASET.DATAROOT = r"E:\BDD100K\dataset root\images"       # the path of images folder
# _C.DATASET.LABELROOT = r"E:\BDD100K\dataset root\det_annotations"      # the path of det_annotations folder
# _C.DATASET.MASKROOT = r"E:\BDD100K\dataset root\da_seg_annotations"               # the path of da_seg_annotations folder
...
# 如果按顺序设为True就是交替训练,会依次训练什么, 1: Da,Ll 2: De 3:E,Da,Ll 4: E,De 5:LL 6:Da 
